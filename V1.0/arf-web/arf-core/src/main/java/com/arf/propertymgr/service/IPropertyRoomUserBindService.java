...
public interface IPropertyRoomUserBindService extends BaseService<PropertyRoomUserBind, Long> {
	...
	PropertyRoomUserBind saveOrUpdate(PropertyRoomUserBind propertyRoomUserBind);
	 ...
	 * @return
	 */
	PropertyRoomUserBind findByBoundNumber(String boundRoom);
	
	PropertyRoomUserBind findByBoundNumberAll(String boundNumber);

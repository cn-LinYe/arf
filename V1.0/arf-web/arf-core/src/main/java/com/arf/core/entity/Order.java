...
public class Order extends BaseEntity<Long> {
	...
	/** 退还的现金劵*/
	private BigDecimal retBalance;
    /** 退还的消费劵*/
    private BigDecimal retVouchers;
	/** 促销名称 */
	...
	/** 未定价订单 */
	private List<NoPricingOrder> noPricingOrderss=new ArrayList<NoPricingOrder>();
	/** 保险 */
	...
	/**  
     * 获取退还的现金劵  
     * @return retBalance 退还的现金劵  
     */
    public BigDecimal getRetBalance() {
        return retBalance;
    }

    /**  
     * 设置退还的现金劵  
     * @param retBalance 退还的现金劵  
     */
    public void setRetBalance(BigDecimal retBalance) {
        this.retBalance = retBalance;
    }

    /**  
     * 获取退还的消费劵  
     * @return retVouchers 退还的消费劵  
     */
    public BigDecimal getRetVouchers() {
        return retVouchers;
    }

    /**  
     * 设置退还的消费劵  
     * @param retVouchers 退还的消费劵  
     */
    public void setRetVouchers(BigDecimal retVouchers) {
        this.retVouchers = retVouchers;
    }

    /**  
     * 获取会员坐标  
     * @return memberPoint 会员坐标  
     */
    @Column(length=100)
    ...
    /**  
     * 获取会员地图定位的位置  
     * @return memberAddress 会员地图定位的位置  
     */
    @Column(length=2000)
    ...
    /**  
     * 获取会员删除  
     * @return memberdel 会员删除  
     */
    @Column()
    public Boolean isMemberdel() {
        return memberdel;
    }

    /**  
     * 设置会员删除  
     * @param memberdel 会员删除  
     */
    public void setMemberdel(Boolean memberdel) {
        this.memberdel = memberdel;
    }

    /**  
     * 获取商户删除  
     * @return memberbizdel 商户删除  
     */
    @Column()
    public Boolean isMemberbizdel() {
        return memberbizdel;
    }

    /**  
     * 设置商户删除  
     * @param memberbizdel 商户删除  
     */
    public void setMemberbizdel(Boolean memberbizdel) {
        this.memberbizdel = memberbizdel;
    }
    ...
    /**  
     * 获取未定价订单  
     * @return noPricingOrderss 未定价订单  
     */
	@OneToMany(mappedBy = "order", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
    public List<NoPricingOrder> getNoPricingOrderss() {
        return noPricingOrderss;
    }

    /**  
     * 设置未定价订单  
     * @param noPricingOrderss 未定价订单  
     */
    public void setNoPricingOrderss(List<NoPricingOrder> noPricingOrderss) {
        this.noPricingOrderss = noPricingOrderss;
    }
	...
	public int getShippableQuantity() {
		if (!hasExpired() && Order.Status.pendingDelivery.equals(getStatus())) {

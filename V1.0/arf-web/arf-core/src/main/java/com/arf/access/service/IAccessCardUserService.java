...
public interface IAccessCardUserService extends
		BaseService<AccessCardUser, Long> {

	/**
	 * 根据用户查询(GROUP BY chipNum)
	 * @param userName
	 * @return
	 */
	...
	/**
	 * 根据用户查询，关联小区、门禁(GROUP BY chipNum)
	 * @param userName
	 * @param boundNumber
	 * @return
	 */

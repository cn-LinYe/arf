...
public interface IPropertyRoomSubuserBindService extends BaseService<PropertyRoomSubuserBind, Long>{
	 ...
	 * @return
	 */
	List<PropertyRoomSubuserBind> findByHouseHolderRoomNumber(String houseHolder,
			String roomNumber);

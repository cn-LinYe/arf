 ...
 * @version 4.0
 */
public interface VipRecordInformationModelService extends BaseService<VipRecordInformationModel, Long> {
	/**
	 * 通过订单号获取订单信息
	 * @param out_trade_no
	 * 订单号
	 ...
	 * @return
	 */
	boolean openEccPaymentCallback(Integer payType, String outTradeNo,BigDecimal totalFee);

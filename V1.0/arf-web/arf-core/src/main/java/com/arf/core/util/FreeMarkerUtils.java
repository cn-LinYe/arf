...
import com.arf.core.EnumConverter;
...
public final class FreeMarkerUtils {
	...
	public static String createHtmlString(String ftlPath, String ftlName,Map<String,Object> dataModel,ServletContext servletContext) throws IOException, TemplateException  {  
        String resultString;  
  
        // 创建Configuration对象  
        Configuration cfg = new Configuration();  
        // 设置FreeMarker的模版文件位置  
        cfg.setServletContextForTemplateLoading(servletContext, ftlPath);  

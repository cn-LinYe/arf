...
public class NonprintUnicodeFilter {
	private static NonprintUnicodeFilter instance = new NonprintUnicodeFilter();
	private final Logger log = LoggerFactory.getLogger(getClass());
	private NonprintUnicodeFilter(){
		super();
	}
	
	public static NonprintUnicodeFilter getInstance(){
		return instance;
	}
	...
	public String filterEmoji(String string) {
		...
		try {
			...
			log.error("过滤特殊字符时出现异常,string="+string,e);
		}
		return "";
	}
